...
import logo from "@/assets/My-Symbol-2.jpg";
import {
  motion,
  AnimatePresence,
  useScroll,
...
export const Navbar = ({ children, className }: NavbarProps) => {
  ...
  return (
    <motion.div
      ...
      className={cn("fixed inset-x-0 top-0 z-40 w-full py-1", className)}
    >
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-white/80 dark:bg-black-100/65",
        className
      )}
    >
      {children}
      ...
      {items.map((item, idx) => (
        ...
        >
          {hovered === idx && (
            <motion.div
              layoutId="hovered"
              className="absolute inset-0 h-full w-full rounded-full bg-gray-100 dark:bg-purple/15 backdrop-blur-lg"
            />
          )}
  ...
  return (
    <motion.div
      ...
      className={cn(
        ...
        visible && "bg-white/80 dark:bg-black-100/30",
        className
      )}
    >
      {children}
